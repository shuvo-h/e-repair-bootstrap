...
const productFeatureValidationSchema = z.object({
    cameraResolution: z.string({invalid_type_error:"must be string"}).optional(),
    storageCapacity: z.string({invalid_type_error:"must be string"}).optional(),
...
const createProductValidationSchema = z.object({
    body: z.object({
        ...
        isAvailable: z.boolean({invalid_type_error:"must be true or false"}).optional(),
        ...
        operatingSystem: z.string({invalid_type_error:"must be string"}).optional(),
        ...
        features: z.array(productFeatureValidationSchema).optional(),
